...
savefilename = 'slmcube_20230621_complsines-01sp_01' # No '.npz'
savefilename = 'testing3'
# datadir = '../pllab_data/'
datadir = 'C:/Data/'
datadir = '/media/morgana2/barnaby/PL/PL_labdata/202306/'
datadir = '/home/bnorris/data/'
datadir = '/Users/bnorris/DontBackup/'
datadir2 = datadir

num_samps = 100#00#000
num_files = 1#0
...
if enable_complexsine:
    dc_power = 0.7
    num_specks = 2#18 # Each has 3 params: [period, ampl1_intens, angle]
    paramlims_lo = [40, 0, 0]
...
for k in range(np.min((nplot, len(complexsine_psfs)))):
    ...
    plt.imshow(cur)
    # plt.imshow(np.log10(cur), vmin=5)
...
# plt.imshow(np.log10(np.sum(complexsine_psfs,0)))
