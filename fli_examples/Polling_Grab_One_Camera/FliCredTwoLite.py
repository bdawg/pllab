...
class FliCredTwoLite:
	...
	#------------------------------------------------------------
	LibLoader.lib.FliCredTwoLite_getCoolingMode_V2.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint8)]
	LibLoader.lib.FliCredTwoLite_getCoolingMode_V2.restype = ctypes.c_bool
	def GetCoolingMode(self, context):
		val = ctypes.c_uint8(0)
		res = LibLoader.lib.FliCredTwoLite_getCoolingMode_V2(context, ctypes.byref(val))
		return res, val.value

	#------------------------------------------------------------
	LibLoader.lib.FliCredTwoLite_getCoolingFirstPoint_V2.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_int16)]
	LibLoader.lib.FliCredTwoLite_getCoolingFirstPoint_V2.restype = ctypes.c_bool
	def GetCoolingFirstPoint(self, context):
		val = ctypes.c_int16(0)
		res = LibLoader.lib.FliCredTwoLite_getCoolingFirstPoint_V2(context, ctypes.byref(val))
		return res, val.value

	#------------------------------------------------------------
	LibLoader.lib.FliCredTwoLite_getCoolingStepWidth_V2.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_uint8)]
	LibLoader.lib.FliCredTwoLite_getCoolingStepWidth_V2.restype = ctypes.c_bool
	def GetCoolingStepWidth(self, context):
		val = ctypes.c_uint8(0)
		res = LibLoader.lib.FliCredTwoLite_getCoolingStepWidth_V2(context, ctypes.byref(val))
		return res, val.value

	#------------------------------------------------------------
	LibLoader.lib.FliCredTwoLite_getSensorSetpoint_V2.argtypes = [ctypes.c_void_p, ctypes.POINTER(ctypes.c_int16)]
	LibLoader.lib.FliCredTwoLite_getSensorSetpoint_V2.restype = ctypes.c_bool
	def GetSensorSetpoint(self, context):
		val = ctypes.c_int16(0)
		res = LibLoader.lib.FliCredTwoLite_getSensorSetpoint_V2(context, ctypes.byref(val))
		return res, val.value
	...
	def SetCoolingState(self, context, value):
		res = LibLoader.lib.FliCredTwoLite_setCoolingState_V2(context, value)
		return res

	#------------------------------------------------------------
	LibLoader.lib.FliCredTwoLite_setCoolingMode_V2.argtypes = [ctypes.c_void_p, ctypes.c_uint8]
	LibLoader.lib.FliCredTwoLite_setCoolingMode_V2.restype = ctypes.c_bool
	def SetCoolingMode(self, context, value):
		res = LibLoader.lib.FliCredTwoLite_setCoolingMode_V2(context, value)
		return res

	#------------------------------------------------------------
	LibLoader.lib.FliCredTwoLite_setCoolingFirstPoint_V2.argtypes = [ctypes.c_void_p, ctypes.c_int16]
	LibLoader.lib.FliCredTwoLite_setCoolingFirstPoint_V2.restype = ctypes.c_bool
	def SetCoolingFirstPoint(self, context, value):
		res = LibLoader.lib.FliCredTwoLite_setCoolingFirstPoint_V2(context, value)
		return res

	#------------------------------------------------------------
	LibLoader.lib.FliCredTwoLite_setCoolingStepWidth_V2.argtypes = [ctypes.c_void_p, ctypes.c_uint8]
	LibLoader.lib.FliCredTwoLite_setCoolingStepWidth_V2.restype = ctypes.c_bool
	def SetCoolingStepWidth(self, context, value):
		res = LibLoader.lib.FliCredTwoLite_setCoolingStepWidth_V2(context, value)
		return res

	#------------------------------------------------------------
	LibLoader.lib.FliCredTwoLite_setSensorSetpoint_V2.argtypes = [ctypes.c_void_p, ctypes.c_int16]
	LibLoader.lib.FliCredTwoLite_setSensorSetpoint_V2.restype = ctypes.c_bool
	def SetSensorSetpoint(self, context, value):
		res = LibLoader.lib.FliCredTwoLite_setSensorSetpoint_V2(context, value)
		return res
